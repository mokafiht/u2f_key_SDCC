 ...
 ******************************************************************************/
 #define UTF16LE_PACKED_STATIC_CONST_STRING_DESC_MFR(__name, __val) \
  SI_SEGMENT_VARIABLE(__name,  static const USB_StringDescriptor_TypeDef, SI_SEG_CODE) = \
    { USB_STRING_DESCRIPTOR_UTF16LE_PACKED, sizeof(__val) * 2, USB_STRING_DESCRIPTOR, 'S','i','l','i','c','o','n',' ','L','a','b','s','\0' }
#define UTF16LE_PACKED_STATIC_CONST_STRING_DESC_PROD(__name, __val) \
  SI_SEGMENT_VARIABLE(__name,  static const USB_StringDescriptor_TypeDef, SI_SEG_CODE) = \
    { USB_STRING_DESCRIPTOR_UTF16LE_PACKED, sizeof(__val) * 2, USB_STRING_DESCRIPTOR, 'U','2','F',' ','Z','e','r','o','\0' }
#define UTF16LE_PACKED_STATIC_CONST_STRING_DESC_SER(__name, __val) \
  SI_SEGMENT_VARIABLE(__name,  static const USB_StringDescriptor_TypeDef, SI_SEG_CODE) = \
    { USB_STRING_DESCRIPTOR_UTF16LE_PACKED, sizeof(__val) * 2, USB_STRING_DESCRIPTOR, 'C','A','F','E','B','A','B','E','F','F','F','F','F','F','F','F','\0' }
#define UTF16LE_PACKED_STATIC_CONST_STRING_DESC_INT0(__name, __val) \
  SI_SEGMENT_VARIABLE(__name,  static const USB_StringDescriptor_TypeDef, SI_SEG_CODE) = \
    { USB_STRING_DESCRIPTOR_UTF16LE_PACKED, sizeof(__val) * 2, USB_STRING_DESCRIPTOR, 'U','2','F',' ','Z','e','r','o','\0' }
/*#define UTF16LE_PACKED_STATIC_CONST_STRING_DESC(__name, __val) \
  SI_SEGMENT_VARIABLE(__name[__size],  static const USB_StringDescriptor_TypeDef, SI_SEG_CODE) = \
...
#define UTF16LE_PACKED_STATIC_CONST_STRING_DESC(__name, __val, __size) \
  ({\
  SI_SEGMENT_VARIABLE(__name[__size],  static const USB_StringDescriptor_TypeDef, SI_SEG_CODE); \
  __name[0] = USB_STRING_DESCRIPTOR_UTF16LE_PACKED;\
  __name[1] = sizeof(__val) * 2;\
  __name[2] = USB_STRING_DESCRIPTOR;\
  int i = 0;\
  for(i=0;i<__size;i++)\
  __name[2 + i] = __val[i];\
  })*/
...
#define MEM_MODEL_SEG  __data
#elif defined __SDCC_MODEL_MEDIUM
#define MEM_MODEL_SEG  __xdata
...
USB_Status_TypeDef USBD_SetupCmdCb(SI_VARIABLE_SEGMENT_POINTER(setup,
                                                               USB_Setup_TypeDef,
                                                               MEM_MODEL_SEG));
//USB_Status_TypeDef USBD_SetupCmdCb(__data USB_Setup_TypeDef *  setup);
