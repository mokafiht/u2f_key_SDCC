...
UTF16LE_PACKED_STATIC_CONST_STRING_DESC_MFR( mfrDesc[], MFR_STRING );
//UTF16LE_PACKED_STATIC_CONST_STRING_DESC( mfrDesc, MFR_STRING, sizeof(MFR_STRING)/sizeof(char) );
UTF16LE_PACKED_STATIC_CONST_STRING_DESC_PROD( prodDesc[], PROD_STRING );
UTF16LE_PACKED_STATIC_CONST_STRING_DESC_SER( serDesc[], SER_STRING );
UTF16LE_PACKED_STATIC_CONST_STRING_DESC_INT0( int0Desc[], INT0_STRING );
