...
;------------------------------------------------------------
;secbyte                   Allocated to stack - _bp +1
;------------------------------------------------------------
	G$eeprom_init$0$0 ==.
	C$eeprom.c$31$0$0 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:31: void eeprom_init()
;	-----------------------------------------
...
_eeprom_init:
	...
	inc	sp
	C$eeprom.c$34$1$108 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:34: eeprom_read(0xFBFF,&secbyte,1);
	mov	r7,_bp
	inc	r7
	mov	r6,#0x00
	mov	r5,#0x40
	...
	mov	sp,a
	C$eeprom.c$35$1$108 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:35: if (secbyte == 0xff)
	mov	r0,_bp
	inc	r0
	cjne	@r0,#0xff,00103$
	C$eeprom.c$37$2$109 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:37: eeprom_erase(0xFBC0);
	mov	a,#0x03
	push	acc
	mov	a,#0x01
	push	acc
	...
	push	acc
	mov	dptr,#0xfbc0
	lcall	__eeprom_write
	mov	a,sp
	add	a,#0xfb
	mov	sp,a
	C$eeprom.c$38$2$109 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:38: secbyte = -32;
	mov	r0,_bp
	inc	r0
	mov	@r0,#0xe0
	C$eeprom.c$39$2$109 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:39: eeprom_write(0xFBFF, &secbyte, 1);
	mov	r7,_bp
	inc	r7
	mov	r6,#0x00
	mov	r5,#0x40
...
;eepaddr                   Allocated to registers 
;old_int                   Allocated to registers b0 
;sloc0                     Allocated to stack - _bp +1
;------------------------------------------------------------
	G$eeprom_read$0$0 ==.
	C$eeprom.c$43$1$108 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:43: void eeprom_read(uint16_t addr, uint8_t * buf, uint8_t len)
;	-----------------------------------------
...
_eeprom_read:
	...
	mov	r7,dph
	C$eeprom.c$45$1$111 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:45: uint8_t __code * eepaddr =  (uint8_t __code *) addr;
	C$eeprom.c$48$1$111 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:48: while(len--)
	mov	a,_bp
	add	a,#0xfb
	mov	r0,a
	mov	ar3,@r0
...
00101$:
	...
	jz	00104$
	C$eeprom.c$50$2$112 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:50: old_int = IE_EA;
	mov	c,_IE_EA
	mov	b0,c
	C$eeprom.c$51$2$112 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:51: IE_EA = 0;
	clr	_IE_EA
	C$eeprom.c$52$2$112 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:52: *buf++ = *eepaddr++;
	mov	dpl,r6
	mov	dph,r7
	clr	a
	movc	a,@a+dptr
	...
	mov	r4,dph
	C$eeprom.c$53$2$112 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:53: IE_EA = old_int;
	mov	c,b0
	mov	_IE_EA,c
	sjmp	00101$
00104$:
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function '_eeprom_write'
;------------------------------------------------------------
;buf                       Allocated to stack - _bp -5
;len                       Allocated to stack - _bp -6
...
;------------------------------------------------------------
	G$_eeprom_write$0$0 ==.
	C$eeprom.c$57$1$111 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:57: void _eeprom_write(uint16_t addr, uint8_t * buf, uint8_t len, uint8_t flags)
;	-----------------------------------------
...
__eeprom_write:
	...
	mov	r7,dph
	C$eeprom.c$59$1$114 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:59: uint8_t __xdata *  eepaddr = (uint8_t __xdata *) addr;
	C$eeprom.c$62$2$115 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:62: while(len--)
	mov	a,_bp
	add	a,#0xf9
	mov	r0,a
	mov	r1,_bp
...
00101$:
	...
	jz	00104$
	C$eeprom.c$64$2$115 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:64: old_int = IE_EA;
	mov	c,_IE_EA
	mov	b0,c
	C$eeprom.c$65$2$115 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:65: IE_EA = 0;
	clr	_IE_EA
	C$eeprom.c$67$2$115 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:67: VDM0CN = 0x80;
	mov	_VDM0CN,#0x80
	C$eeprom.c$68$2$115 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:68: RSTSRC = 0x02;
	mov	_RSTSRC,#0x02
	C$eeprom.c$71$2$115 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:71: FLKEY  = 0xA5;
	mov	_FLKEY,#0xa5
	C$eeprom.c$72$2$115 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:72: FLKEY  = 0xF1;
	mov	_FLKEY,#0xf1
	C$eeprom.c$73$2$115 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:73: PSCTL |= flags;
	mov	a,_bp
	add	a,#0xf9
	mov	r0,a
	mov	a,@r0
	orl	_PSCTL,a
	C$eeprom.c$75$2$115 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:75: *eepaddr = *buf;
	mov	dpl,r2
	mov	dph,r3
	mov	b,r4
	lcall	__gptrget
	...
	mov	r7,dph
	C$eeprom.c$76$2$115 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:76: PSCTL &= ~flags;
	mov	r0,_bp
	inc	r0
	inc	r0
	mov	a,@r0
	anl	_PSCTL,a
	C$eeprom.c$77$2$115 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:77: IE_EA = old_int;
	mov	c,b0
	mov	_IE_EA,c
	C$eeprom.c$79$2$115 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:79: eepaddr++;
	C$eeprom.c$80$2$115 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\eeprom.c:80: buf++;
	sjmp	00101$
00104$:
	mov	sp,_bp
	pop	_bp
	C$eeprom.c$82$1$114 ==.
	XG$_eeprom_write$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
	.area XINIT   (CODE)
