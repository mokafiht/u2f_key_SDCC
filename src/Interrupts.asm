...
;--------------------------------------------------------
	...
	.globl _SMB_crc
	.globl _SMB_preflags
	.globl _SMB_write_ext_buf
	.globl _SMB_read_buf
	.globl _SMB_write_buf
	.globl _SMB_FLAGS
	.globl _SMB_crc_offset
	.globl _SMB_write_ext_offset
	.globl _SMB_write_ext_len
	.globl _SMB_read_offset
	.globl _SMB_read_len
	.globl _SMB_write_offset
	.globl _SMB_write_len
	.globl _SMB_addr
	.globl __MS_
;--------------------------------------------------------
...
_SMB_write_len::
	.ds 1
G$SMB_write_offset$0$0==.
_SMB_write_offset::
	.ds 1
G$SMB_read_len$0$0==.
_SMB_read_len::
	.ds 1
G$SMB_read_offset$0$0==.
_SMB_read_offset::
	.ds 1
G$SMB_write_ext_len$0$0==.
_SMB_write_ext_len::
	.ds 1
G$SMB_write_ext_offset$0$0==.
_SMB_write_ext_offset::
	.ds 1
G$SMB_crc_offset$0$0==.
_SMB_crc_offset::
	.ds 1
G$SMB_FLAGS$0$0==.
_SMB_FLAGS::
...
;--------------------------------------------------------
	...
	.area GSFINAL (CODE)
	.area GSINIT  (CODE)
	C$Interrupts.c$35$0$0 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\Interrupts.c:35: uint32_t __data _MS_ = 0;
	clr	a
	mov	__MS_,a
	mov	(__MS_ + 1),a
	mov	(__MS_ + 2),a
	mov	(__MS_ + 3),a
	C$Interrupts.c$52$0$0 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\Interrupts.c:52: __data uint8_t SMB_addr 				= 0;
;	1-genFromRTrack replaced	mov	_SMB_addr,#0x00
	mov	_SMB_addr,a
	C$Interrupts.c$54$0$0 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\Interrupts.c:54: __data uint8_t SMB_write_len 			= 0;
;	1-genFromRTrack replaced	mov	_SMB_write_len,#0x00
	mov	_SMB_write_len,a
	C$Interrupts.c$55$0$0 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\Interrupts.c:55: __data uint8_t SMB_write_offset 		= 0;
;	1-genFromRTrack replaced	mov	_SMB_write_offset,#0x00
	mov	_SMB_write_offset,a
	C$Interrupts.c$56$0$0 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\Interrupts.c:56: __data uint8_t SMB_read_len 			= 0;
;	1-genFromRTrack replaced	mov	_SMB_read_len,#0x00
	mov	_SMB_read_len,a
	C$Interrupts.c$57$0$0 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\Interrupts.c:57: __data uint8_t SMB_read_offset 		= 0;
;	1-genFromRTrack replaced	mov	_SMB_read_offset,#0x00
	mov	_SMB_read_offset,a
	C$Interrupts.c$60$0$0 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\Interrupts.c:60: __data uint8_t  SMB_write_ext_len 	= 0;
;	1-genFromRTrack replaced	mov	_SMB_write_ext_len,#0x00
	mov	_SMB_write_ext_len,a
	C$Interrupts.c$61$0$0 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\Interrupts.c:61: __data uint8_t  SMB_write_ext_offset 	= 0;
;	1-genFromRTrack replaced	mov	_SMB_write_ext_offset,#0x00
	mov	_SMB_write_ext_offset,a
	C$Interrupts.c$64$0$0 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\Interrupts.c:64: __data uint8_t  SMB_crc_offset 		= 0;
;	1-genFromRTrack replaced	mov	_SMB_crc_offset,#0x00
	mov	_SMB_crc_offset,a
	C$Interrupts.c$65$0$0 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\Interrupts.c:65: __data volatile uint8_t SMB_FLAGS 	= 0;
;	1-genFromRTrack replaced	mov	_SMB_FLAGS,#0x00
	mov	_SMB_FLAGS,a
;--------------------------------------------------------
; Home
;--------------------------------------------------------
...
;--------------------------------------------------------
	...
	.area CONST   (CODE)
	.area XINIT   (CODE)
FInterrupts$__xinit_SMB_write_buf$0$0 == .
__xinit__SMB_write_buf:
	.byte #0x00,#0x00,#0x00
FInterrupts$__xinit_SMB_read_buf$0$0 == .
__xinit__SMB_read_buf:
	.byte #0x00,#0x00,#0x00
FInterrupts$__xinit_SMB_write_ext_buf$0$0 == .
__xinit__SMB_write_ext_buf:
	.byte #0x00,#0x00,#0x00
FInterrupts$__xinit_SMB_preflags$0$0 == .
__xinit__SMB_preflags:
	.db #0x00	; 0
FInterrupts$__xinit_SMB_crc$0$0 == .
__xinit__SMB_crc:
	.byte #0x00,#0x00	; 0
	.area CABS    (ABS,CODE)
