...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'custom_command'
;------------------------------------------------------------
;msg                       Allocated to stack - _bp +1
;res                       Allocated to stack - _bp +8
;ec                        Allocated to stack - _bp +12
;sloc0                     Allocated to stack - _bp +4
;sloc1                     Allocated to stack - _bp +5
;------------------------------------------------------------
	G$custom_command$0$0 ==.
	C$custom.c$37$0$0 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:37: uint8_t custom_command(struct u2f_hid_msg * msg)
;	-----------------------------------------
...
_custom_command:
	...
	mov	sp,a
	C$custom.c$42$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:42: switch(msg->pkt.init.cmd)
	mov	r0,_bp
	inc	r0
	mov	a,#0x04
	add	a,@r0
...
00145$:
	ljmp	00111$
	C$custom.c$45$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:45: case U2F_CUSTOM_GET_RNG:
00101$:
	C$custom.c$49$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:49: sizeof(appdata.tmp), &res) == 0 )
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,_bp
	...
	mov	r7,#0x40
	C$custom.c$48$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:48: appdata.tmp,
	C$custom.c$46$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:46: if (atecc_send_recv(ATECC_CMD_RNG,ATECC_RNG_P1,ATECC_RNG_P2,
	push	ar4
	push	ar3
	push	ar2
	push	ar5
...
00146$:
	C$custom.c$51$3$126 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:51: memmove(msg->pkt.init.payload, res.buf, 32);
	mov	a,_bp
	add	a,#0x04
	mov	r0,a
	mov	a,@r0
	...
	pop	ar4
	C$custom.c$52$3$126 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:52: U2FHID_SET_LEN(msg, 32);
	mov	a,#0x01
	add	a,r2
	mov	r5,a
	clr	a
	...
	lcall	__gptrput
	C$custom.c$53$3$126 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:53: usb_write((uint8_t*)msg, 64);
	mov	r0,_bp
	inc	r0
	mov	ar5,@r0
	inc	r0
...
00103$:
	C$custom.c$57$3$127 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:57: U2FHID_SET_LEN(msg, 0);
	mov	a,#0x01
	add	a,r2
	mov	r5,a
	clr	a
	...
	lcall	__gptrput
	C$custom.c$58$3$127 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:58: usb_write((uint8_t*)msg, 64);
	mov	r0,_bp
	inc	r0
	mov	ar5,@r0
	inc	r0
	...
	dec	sp
	C$custom.c$61$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:61: break;
	ljmp	00112$
	C$custom.c$64$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:64: case U2F_CUSTOM_SEED_RNG:
00105$:
	C$custom.c$68$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:68: sizeof(appdata.tmp), &res);
	mov	a,_bp
	add	a,#0x08
	mov	r7,a
	mov	a,_bp
	...
	mov	@r0,#0x40
	C$custom.c$67$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:67: appdata.tmp,
	C$custom.c$66$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:66: msg->pkt.init.payload, 20,
	mov	a,#0x03
	add	a,r2
	mov	r5,a
	clr	a
	...
	mov	ar7,r4
	C$custom.c$65$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:65: ec = atecc_send_recv(ATECC_CMD_NONCE,ATECC_NONCE_RNG_UPDATE,0,
	push	ar4
	push	ar3
	push	ar2
	mov	a,_bp
	...
	mov	@r0,ar7
	C$custom.c$69$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:69: U2FHID_SET_LEN(msg, 1);
	mov	a,#0x01
	add	a,r2
	mov	r5,a
	clr	a
	...
	lcall	__gptrput
	C$custom.c$70$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:70: msg->pkt.init.payload[0] = ec == 0 ? 1 : 0;
	mov	a,#0x03
	add	a,r2
	mov	r5,a
	clr	a
...
00116$:
	...
	lcall	__gptrput
	C$custom.c$71$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:71: usb_write((uint8_t*)msg, 64);
	mov	r0,_bp
	inc	r0
	mov	ar5,@r0
	inc	r0
	...
	dec	sp
	C$custom.c$72$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:72: break;
	ljmp	00112$
	C$custom.c$75$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:75: case U2F_CUSTOM_WINK:
00106$:
	C$custom.c$77$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:77: app_wink(U2F_COLOR_WINK);
	mov	dptr,#0x0000
	mov	b,#0x12
	clr	a
	lcall	_app_wink
	C$custom.c$79$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:79: break;
	ljmp	00112$
	C$custom.c$81$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:81: case U2F_CONFIG_BOOTLOADER:
00107$:
	C$custom.c$85$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:85: appdata.tmp, sizeof(appdata.tmp), &res);
	mov	a,_bp
	add	a,#0x08
	mov	r7,a
	mov	r4,a
	...
	mov	r6,#0x40
	C$custom.c$83$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:83: atecc_send_recv(ATECC_CMD_READ,
	push	ar7
	push	ar4
	push	ar5
	push	ar6
	...
	pop	ar7
	C$custom.c$87$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:87: if (res.buf[0] == 0xff)
	mov	a,r7
	inc	a
	mov	r1,a
	mov	ar5,@r1
	...
	cjne	r5,#0xff,00112$
	C$custom.c$89$3$128 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:89: *((uint8_t SI_SEG_DATA *)0x00) = 0xA5;
	mov	r0,#0x00
	mov	@r0,#0xa5
	C$custom.c$90$3$128 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:90: RSTSRC = RSTSRC_SWRSF__SET | RSTSRC_PORSF__SET;
	mov	_RSTSRC,#0x12
	C$custom.c$94$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:94: break;
	C$custom.c$95$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:95: case U2F_CONFIG_BOOTLOADER_DESTROY:
	sjmp	00112$
00110$:
	C$custom.c$97$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:97: memset(appdata.tmp,0,4);
	mov	a,#0x04
	push	acc
	clr	a
	push	acc
	...
	dec	sp
	dec	sp
	C$custom.c$101$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:101: appdata.tmp, sizeof(appdata.tmp), &res);
	mov	a,_bp
	add	a,#0x08
	mov	r7,a
	mov	r6,#0x00
	mov	r5,#0x40
	C$custom.c$100$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:100: ATECC_RW_DATA, ATECC_EEPROM_DATA_SLOT(8), appdata.tmp, 4,
	C$custom.c$99$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:99: atecc_send_recv(ATECC_CMD_WRITE,
	push	ar7
	push	ar6
	push	ar5
	mov	a,#0x46
	...
	add	a,#0xf2
	mov	sp,a
	C$custom.c$103$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:103: break;
	C$custom.c$104$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:104: default:
	sjmp	00112$
00111$:
	C$custom.c$105$2$125 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:105: return 0;
	mov	dpl,#0x00
	C$custom.c$106$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:106: }
	sjmp	00113$
00112$:
	C$custom.c$107$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\custom.c:107: return 1;
	mov	dpl,#0x01
00113$:
	mov	sp,_bp
	pop	_bp
	C$custom.c$108$1$124 ==.
	XG$custom_command$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
	.area XINIT   (CODE)
