...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'smb_read'
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$smb_read$0$0 ==.
	C$i2c.c$35$0$0 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:35: uint8_t smb_read (uint8_t addr, uint8_t* dest, uint8_t count)
;	-----------------------------------------
;	 function smb_read
;	-----------------------------------------
_smb_read:
	...
	mov	r7,dpl
	C$i2c.c$37$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:37: while(SMB_IS_BUSY()){}
00101$:
	mov	a,_SMB_FLAGS
	jb	acc.1,00101$
	C$i2c.c$39$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:39: SMB_crc = 0;
	mov	dptr,#_SMB_crc
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
	C$i2c.c$40$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:40: SMB_crc_offset = 0;
;	1-genFromRTrack replaced	mov	_SMB_crc_offset,#0x00
	mov	_SMB_crc_offset,a
	C$i2c.c$41$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:41: SMB_FLAGS = SMB_READ | SMB_BUSY | SMB_preflags;
	mov	dptr,#_SMB_preflags
	movx	a,@dptr
	mov	r6,a
	mov	a,#0x03
	orl	a,r6
	mov	_SMB_FLAGS,a
	C$i2c.c$42$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:42: SMB_preflags = 0;
	clr	a
	movx	@dptr,a
	C$i2c.c$44$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:44: SMB_read_offset = 0;
;	1-genFromRTrack replaced	mov	_SMB_read_offset,#0x00
	mov	_SMB_read_offset,a
	C$i2c.c$45$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:45: SMB_addr = addr;
	mov	_SMB_addr,r7
	C$i2c.c$46$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:46: SMB_read_len = count;
	mov	a,_bp
	add	a,#0xfa
	mov	r0,a
	mov	_SMB_read_len,@r0
	C$i2c.c$47$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:47: SMB_read_buf = dest;
	mov	a,_bp
	add	a,#0xfb
	mov	r0,a
	mov	dptr,#_SMB_read_buf
	mov	a,@r0
	movx	@dptr,a
	inc	r0
	mov	a,@r0
	...
	movx	@dptr,a
	C$i2c.c$48$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:48: SMB0CN0_STA = 1;
	setb	_SMB0CN0_STA
	C$i2c.c$50$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:50: while(SMB_IS_BUSY()){}
00104$:
	mov	a,_SMB_FLAGS
	jb	acc.1,00104$
	C$i2c.c$51$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:51: return SMB_read_len;
	mov	dpl,_SMB_read_len
	pop	_bp
	C$i2c.c$52$1$124 ==.
	XG$smb_read$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'smb_write'
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$smb_write$0$0 ==.
	C$i2c.c$55$1$124 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:55: void smb_write (uint8_t addr, uint8_t* buf, uint8_t len)
;	-----------------------------------------
;	 function smb_write
;	-----------------------------------------
_smb_write:
	...
	mov	r7,dpl
	C$i2c.c$57$1$128 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:57: while(SMB_IS_BUSY()){}
00101$:
	mov	a,_SMB_FLAGS
	jb	acc.1,00101$
	C$i2c.c$59$1$128 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:59: SMB_crc = 0;
	mov	dptr,#_SMB_crc
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
	C$i2c.c$60$1$128 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:60: SMB_crc_offset = 0;
;	1-genFromRTrack replaced	mov	_SMB_crc_offset,#0x00
	mov	_SMB_crc_offset,a
	C$i2c.c$61$1$128 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:61: SMB_FLAGS = SMB_WRITE | SMB_BUSY | SMB_preflags;
	mov	dptr,#_SMB_preflags
	movx	a,@dptr
	mov	r6,a
	mov	a,#0x02
	...
	mov	_SMB_FLAGS,a
	C$i2c.c$62$1$128 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:62: SMB_preflags = 0;
	clr	a
	movx	@dptr,a
	C$i2c.c$64$1$128 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:64: SMB_write_len = len;
	mov	a,_bp
	add	a,#0xfa
	mov	r0,a
	mov	_SMB_write_len,@r0
	C$i2c.c$65$1$128 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:65: SMB_write_buf = buf;
	mov	a,_bp
	add	a,#0xfb
	mov	r0,a
	mov	dptr,#_SMB_write_buf
	mov	a,@r0
	movx	@dptr,a
	inc	r0
	mov	a,@r0
	...
	movx	@dptr,a
	C$i2c.c$66$1$128 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:66: SMB_write_offset = 0;
	mov	_SMB_write_offset,#0x00
	C$i2c.c$67$1$128 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:67: SMB_addr = addr;
	mov	_SMB_addr,r7
	C$i2c.c$69$1$128 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:69: SMB0CN0_STA = 1;
	setb	_SMB0CN0_STA
	C$i2c.c$70$1$128 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:70: while(SMB_IS_BUSY()){}
00104$:
	mov	a,_SMB_FLAGS
	jb	acc.1,00104$
	pop	_bp
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'smb_set_ext_write'
;------------------------------------------------------------
;extlen                    Allocated to stack - _bp -3
;extbuf                    Allocated to registers r5 r6 r7 
;------------------------------------------------------------
	G$smb_set_ext_write$0$0 ==.
	C$i2c.c$73$1$128 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:73: void smb_set_ext_write( uint8_t* extbuf, uint8_t extlen)
;	-----------------------------------------
;	 function smb_set_ext_write
;	-----------------------------------------
_smb_set_ext_write:
	push	_bp
	mov	_bp,sp
	...
	mov	r7,b
	C$i2c.c$75$1$132 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:75: while(SMB_IS_BUSY()){}
00101$:
	mov	a,_SMB_FLAGS
	jb	acc.1,00101$
	C$i2c.c$76$1$132 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:76: SMB_write_ext_len = extlen;
	mov	a,_bp
	add	a,#0xfd
	mov	r0,a
	mov	_SMB_write_ext_len,@r0
	C$i2c.c$77$1$132 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:77: SMB_write_ext_buf = extbuf;
	mov	dptr,#_SMB_write_ext_buf
	mov	a,r5
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	...
	movx	@dptr,a
	C$i2c.c$78$1$132 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:78: SMB_write_ext_offset = 0;
	mov	_SMB_write_ext_offset,#0x00
	C$i2c.c$79$1$132 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:79: SMB_preflags |= SMB_WRITE_EXT;
	mov	dptr,#_SMB_preflags
	movx	a,@dptr
	mov	r7,a
	mov	a,#0x04
	...
	pop	_bp
	C$i2c.c$80$1$132 ==.
	XG$smb_set_ext_write$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'feed_crc'
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$feed_crc$0$0 ==.
	C$i2c.c$83$1$132 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:83: uint16_t feed_crc(uint16_t crc, uint8_t b)
;	-----------------------------------------
;	 function feed_crc
;	-----------------------------------------
_feed_crc:
	...
	mov	r7,dph
	C$i2c.c$85$1$135 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:85: crc ^= b;
	mov	a,_bp
	add	a,#0xfd
	mov	r0,a
	mov	ar4,@r0
	...
	xrl	ar7,a
	C$i2c.c$86$1$135 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:86: crc = crc & 1 ? (crc >> 1) ^ 0xa001 : crc >> 1;
	mov	a,r6
	jnb	acc.0,00103$
	mov	ar4,r6
	mov	a,r7
...
00104$:
	...
	mov	ar7,r5
	C$i2c.c$87$1$135 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:87: crc = crc & 1 ? (crc >> 1) ^ 0xa001 : crc >> 1;
	mov	a,r6
	jnb	acc.0,00105$
	mov	ar4,r6
	mov	a,r7
...
00106$:
	...
	mov	ar7,r5
	C$i2c.c$88$1$135 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:88: crc = crc & 1 ? (crc >> 1) ^ 0xa001 : crc >> 1;
	mov	a,r6
	jnb	acc.0,00107$
	mov	ar4,r6
	mov	a,r7
...
00108$:
	...
	mov	ar7,r5
	C$i2c.c$89$1$135 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:89: crc = crc & 1 ? (crc >> 1) ^ 0xa001 : crc >> 1;
	mov	a,r6
	jnb	acc.0,00109$
	mov	ar4,r6
	mov	a,r7
...
00110$:
	...
	mov	ar7,r5
	C$i2c.c$90$1$135 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:90: crc = crc & 1 ? (crc >> 1) ^ 0xa001 : crc >> 1;
	mov	a,r6
	jnb	acc.0,00111$
	mov	ar4,r6
	mov	a,r7
...
00112$:
	...
	mov	ar7,r5
	C$i2c.c$91$1$135 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:91: crc = crc & 1 ? (crc >> 1) ^ 0xa001 : crc >> 1;
	mov	a,r6
	jnb	acc.0,00113$
	mov	ar4,r6
	mov	a,r7
...
00114$:
	...
	mov	ar7,r5
	C$i2c.c$92$1$135 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:92: crc = crc & 1 ? (crc >> 1) ^ 0xa001 : crc >> 1;
	mov	a,r6
	jnb	acc.0,00115$
	mov	ar4,r6
	mov	a,r7
...
00116$:
	...
	mov	ar7,r5
	C$i2c.c$93$1$135 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:93: return crc & 1 ? (crc >> 1) ^ 0xa001 : crc >> 1;
	mov	a,r6
	jnb	acc.0,00117$
	mov	ar4,r6
	mov	a,r7
...
00118$:
	...
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'reverse_bits'
;------------------------------------------------------------
;crc                       Allocated to registers r6 r7 
;------------------------------------------------------------
	G$reverse_bits$0$0 ==.
	C$i2c.c$97$1$135 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:97: uint16_t reverse_bits(uint16_t crc)
;	-----------------------------------------
...
_reverse_bits:
	...
	mov	r7,dph
	C$i2c.c$100$1$137 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:100: crc = (((crc & 0xaaaa) >> 1) | ((crc & 0x5555) << 1));
	mov	a,#0xaa
	anl	a,r6
	mov	r4,a
	mov	a,#0xaa
	...
	mov	r7,a
	C$i2c.c$101$1$137 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:101: crc = (((crc & 0xcccc) >> 2) | ((crc & 0x3333) << 2));
	mov	a,#0xcc
	anl	a,r6
	mov	r4,a
	mov	a,#0xcc
	...
	mov	r7,a
	C$i2c.c$102$1$137 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:102: crc = (((crc & 0xf0f0) >> 4) | ((crc & 0x0f0f) << 4));
	mov	a,#0xf0
	anl	a,r6
	mov	r4,a
	mov	a,#0xf0
	...
	mov	r7,a
	C$i2c.c$103$1$137 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:103: return (((crc & 0xff00) >> 8) | ((crc & 0x00ff) << 8));
	mov	ar5,r7
	mov	ar4,r5
	mov	r5,#0x00
	mov	ar7,r6
...
;------------------------------------------------------------
	G$smb_init$0$0 ==.
	C$i2c.c$106$1$137 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:106: void smb_init()
;	-----------------------------------------
;	 function smb_init
;	-----------------------------------------
_smb_init:
	C$i2c.c$108$1$138 ==.
;	D:\Freelancer_projects\jan333\sdcc_project\src\i2c.c:108: SMB_FLAGS = 0;
	mov	_SMB_FLAGS,#0x00
	C$i2c.c$109$1$138 ==.
	XG$smb_init$0$0 ==.
	ret
